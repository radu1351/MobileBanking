...
public class FirestoreManager {
    ...
    void addCardToDatabase(CreditCard creditCard) {
        creditCards.add(creditCard);
    ...
    void updateCreditCardDatabase(ArrayList<CreditCard> creditCards) {
    ...
    void addDepositToDatabase(Deposit deposit) {
        deposits.add(deposit);
    ...
    void updateRequestInDatabase(Request request) {
    ...
    void removeDepositFromDatabase(Deposit deposit) {
    ...
    void addCreditToDatabase(Credit credit) {
        //Update the local variables
    ...
    void payCreditInDatabase(Credit credit) {
